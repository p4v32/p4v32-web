...
function lighti() {
  ...
  //document.getElementById('2s').style.borderColor = 'black';
  document.body.style.color = 'Black';
  //document.getElementById('1s').style.borderColor = 'Black';
  document.body.style.borderColor = 'Black';
  document.body.table.td.style.borderColor = 'Cyan';
...
function darki() {
  ...
  document.body.style.backgroundColor = '#0b172a';
  document.body.style.color = 'white';
  //document.getElementById('1s').style.borderColor = 'Cyan';
//  document.getElementById('2s').style.backgroundColor = '#0b172a';
//  document.getElementById('2s').style.borderColor = 'Cyan';
